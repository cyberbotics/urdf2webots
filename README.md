...
The script accepts the following arguments:
  ...
  - **--init-pos=JointPositions**: Set the initial positions of your robot joints. Example: `--init_pos="[1.2, 0.5, -1.5]"` would set the first 3 joits of your robot to the specified values, and leave the rest with their default value.
